		...
		<div class="col-md-12 ">
			<div class="row justify-content-center">
				<div class=" col-md-2 form-group">
					<form method="POST" action="<?= base_url(); ?>/index.php/turmas2/busca">
									...
									<?php foreach($turma as $turma){  ?>
										<tr>
											...
											<?php	}else{ ?>
												...
												<?php	} ?></td>
												<td > 
													<a href="<?php if($turma['status']==1) { ?><?= base_url(); ?>/index.php/Turmas2/editarTurma/<?= $turma['id']?><?php } else { ?><?= base_url(); ?>/index.php/Turmas2/editarTurma/<?= $turma['id']//montar um js talves para o ELSE 
													?> <?php } ?>">     
													<button style="width: 100%;height: 30px;line-height:10px;" class="btn btn-success " >Editar</button></a>
												</td>
												<td>

													<a href="<?php if($turma['status'] == 1) { ?><?=base_url()?>/index.php/Turmas2/desativarTurma/<?=$turma['id'] ?><?php } else { ?>#<?php } ?>"> <button style="width: 80%;height: 30px;line-height:10px;" class="btn btn-danger" >Desativar</button></a>
												...
												<td>
													...
													<a href="<?php if($turma['status'] == 0) { ?><?=base_url()?>/index.php/Turmas2/ativarTurma/<?=$turma['id'] ?><?php } else { ?>#<?php } ?>"><button style="width: 80%;height: 30px;line-height:10px;" class="btn btn-info">Reativar</button></a>
												</td>
											</tr>
